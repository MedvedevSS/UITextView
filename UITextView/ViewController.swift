...
//  UITextView
//
//  Created by Сергей Медведев on 06.04.2021.
//
...
//        textView.text = ""
    ...
    // Скытие клавиатуры по тапу за пределами Text View
...
extension ViewController: UITextViewDelegate {
    ...
    func textViewDidEndEditing(_ textView: UITextView) { // Срабатывает по окончанию работы
